import cheerio from "http://mirror.ghproxy.com/https://raw.githubusercontent.com/myfieewifi/iptv/main/js/lib/cheerio.min.js";
import "http://mirror.ghproxy.com/https://raw.githubusercontent.com/myfieewifi/iptv/main/js/lib/crypto-js.js";
import 模板 from "http://mirror.ghproxy.com/https://raw.githubusercontent.com/myfieewifi/iptv/main/js/模板.js";
import {gbkTool} from "http://mirror.ghproxy.com/https://raw.githubusercontent.com/myfieewifi/iptv/main/js/lib/gbk.js";
...
const parseTags = {
    jsp: {pdfh: pdfh2, pdfa: pdfa2, pd: pd2}, json: {
        pdfh(html, parse) {
            if (!parse || !parse.trim()) {
                return ""
            }
...
var OcrApi = {
    api: OCR_API, classification: function (img) {
        let code = "";
        try {
            ...
            if (homeVodObj.double) {
                ...
                for (let item of items) {
                    try {
                        ...
                        let vod = {vod_name: title, vod_pic: img, vod_remarks: desc, vod_content: content, vod_id: vid};
                        d.push(vod)
                    } catch (e) {
...
function categoryParse(cateObj) {
    ...
    let nodata = {
        list: [{
            ...
            vod_id: "no_data",
            vod_remarks: "不要点,会崩的",
            vod_pic: "http://mirror.ghproxy.com/https://raw.githubusercontent.com/hjdhnx/dr_py/main/404.jpg"
...
function search(wd, quick) {
    ...
    let searchObj = {searchUrl: rule.searchUrl, "搜索": rule.搜索, wd: wd, pg: 1, quick: quick};
...
function isVideo(url) {
    ...
    let isVideoObj = {url: url, isVideo: rule.isVideo, t: t};
